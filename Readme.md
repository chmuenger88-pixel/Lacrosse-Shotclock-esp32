...
3. **Code hochladen**
   - `web_master_v1_0_0.ino` auf den Web-Master ESP32 hochladen
   - `send_master_v1_0_0.ino` auf den Send-Master ESP32 hochladen
   - `receiver_v1_0_0.ino` auf beide Anzeigemodule hochladen
...
4. **MAC-Adressen eintragen (WICHTIG)**
   ...
   - Trage die Adressen im Send-Master-Code ein:
     ```cpp
     uint8_t receiver1MacAddress[] = {0xXX, 0xXX, 0xXX, 0xXX, 0xXX, 0xXX};
...
- **Strafen:** Ein zusätzliches Panel beim Master für Anzeige der Strafen
- **Speichern:** Automatisches speichern und laden des letzten Modus beim neustarten
- **Spielberichtsbogen:** Integration von Spielberichtsbogen, automatische Erfassung der Zeit mit Angabe von Torschütze und Assist sowie Strafen
